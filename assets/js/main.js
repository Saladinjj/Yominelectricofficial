...
const T = {
  en: {
    ...
    prod_request_quote:'Request Quote', prod_quote_busbar_desc:'Busbar pricing is project-specific. Submit your drawings and specifications for a formal quotation first — our team will review and negotiate terms with you.', prod_pricing:'Pricing',
  ...
  fr: {
    ...
    prod_request_quote:'Demander un Devis', prod_quote_busbar_desc:'Le tarif des barres omnibus dépend du projet. Envoyez vos plans et spécifications pour un devis formel — notre équipe examinera puis négociera les conditions avec vous.', prod_pricing:'Tarification',
  },
  ar: {
    ...
    prod_request_quote:'طلب عرض سعر', prod_quote_busbar_desc:'تسعير القضبان يعتمد على المشروع. أرسل المخططات والمواصفات للحصول على عرض رسمي أولاً — ثم تتفاوض فرقتنا معك على الشروط.', prod_pricing:'التسعير',
  }
};
