...
ft_copy:'© 2026 Yomin Electric Co., Ltd. All rights reserved.',
    ...
    prod_cat_energy_meter:'Energy Meters', prod_cat_voltage_stabilizer:'Voltage Stabilizers', prod_cat_current_transformer:'Current Transformers', prod_cat_screw_machine:'Screw Machines', prod_cat_busbar:'Busbars', prod_cat_flexible_busbar:'Flexible Busbar', prod_cat_rigid_busbar:'Rigid Busbar', prod_cat_aluminum_busbar:'Aluminum Busbar', prod_cat_composite_busbar:'Composite Laminated', prod_cat_ccs_busbar:'CCS Integrated', prod_cat_heavy_busbar:'Heavy Duty Busbar', prod_cat_storage_busbar:'Energy Storage', prod_cat_busbar_protection:'Busbar Protection', prod_cat_variac:'Variac / Transformers', prod_cat_terminal:'Terminals & Connectors', prod_cat_solar:'Solar & PV', prod_cat_fuse:'Fuses & Protection', prod_cat_voltage_protector:'Voltage Protectors', prod_cat_socket:'Sockets & Wiring', prod_cat_tools:'Tools & Hardware', prod_cat_seal:'Security Seals', prod_cat_other:'Other Products',
