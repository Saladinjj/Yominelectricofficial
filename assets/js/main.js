...
ft_desc:'Precision energy metering solutions for global buyers. Trusted in 95+ countries since 1996.',
ft_copy:'© 2026 Yomin Electric Co., Ltd. All rights reserved.',
    ...
    about_desc:'Since 1996, Yomin Electric has been engineering electrical metering solutions that power homes, businesses, and infrastructure across more than 95 countries worldwide.',
    about_intro_lbl:'Company Introduction', about_intro_h2:'Zhejiang Yomin Electric Co., Ltd.',
    about_intro_p1:'Founded in 1996 and headquartered in Zhejiang Province, Yomin Electric has grown from a local manufacturer into a globally trusted supplier of precision energy metering products.',
    ...
    about_intro_p3:'With a team of over 370 engineers and technicians, we serve utility companies, contractors, distributors, and OEM partners across Asia, Africa, Europe, the Middle East, and the Americas.',
    ...
    about_history_lbl:'Company Timeline', about_history_h2:'Three Decades of Growth', about_history_desc:'From a small workshop to a global exporter.',
    ...
    prod_desc_suffix:' — Trusted B2B manufacturer and global exporter since 1996. Our products are CE and IEC certified, serving power utilities and industrial projects in 95+ countries. Factory-direct pricing and custom OEM/ODM solutions available.',
    prod_desc:'Browse our complete range of precision energy meters, industrial voltage stabilizers, high-accuracy current transformers, and electrical accessories. Trusted by buyers in 95+ countries.',
    prod_cat_energy_meter:'Precision Energy Meters & Smart IoT Metering', prod_cat_voltage_stabilizer:'Industrial Voltage Stabilizers & AVR', prod_cat_current_transformer:'High-Accuracy Current Transformers (CT)', prod_cat_screw_machine:'Automatic Screw Machines', prod_cat_busbar:'Custom Electrical Busbars', prod_cat_flexible_busbar:'Flexible Copper Busbars', prod_cat_rigid_busbar:'Rigid Power Busbars', prod_cat_aluminum_busbar:'Aluminum Busbars', prod_cat_composite_busbar:'Composite Laminated Busbars', prod_cat_ccs_busbar:'CCS Integrated Busbars', prod_cat_heavy_busbar:'Heavy Duty Busbars', prod_cat_storage_busbar:'Energy Storage Busbars', prod_cat_busbar_protection:'Busbar Protection Sleeves', prod_cat_variac:'Variac Transformers & Voltage Regulators', prod_cat_terminal:'Electrical Terminals & Connectors', prod_cat_solar:'Solar PV Components & Combiner Boxes', prod_cat_fuse:'Industrial Fuses & Protection', prod_cat_voltage_protector:'Automatic Voltage Protectors', prod_cat_emergency:'Emergency Lighting EPS & Controllers', prod_cat_socket:'Industrial Sockets & Wiring', prod_cat_tools:'Electrical Tools & Hardware', prod_cat_seal:'Security & Meter Seals', prod_cat_other:'Other Electrical Products',
    prod_request_quote:'Request Quote', prod_quote_busbar_desc:'Busbar pricing is project-specific. Submit your drawings and specifications for a formal quotation first — our team will review and negotiate terms with you.', prod_pricing:'Pricing', prod_busbar_choose:'Choose busbar type', prod_busbar_all:'All Busbars',
...
ft_desc:'Solutions de comptage d\'énergie de précision. Présents dans plus de 95 pays depuis 1996.',
ft_copy:'© 2026 Yomin Electric Co., Ltd. Tous droits réservés.',
    ...
    about_desc:'Depuis 1996, Yomin Electric conçoit des solutions de comptage dans plus de 95 pays.',
    about_intro_lbl:'Présentation', about_intro_h2:'Zhejiang Yomin Electric Co., Ltd.',
    about_intro_p1:'Fondée en 1996 dans le Zhejiang, Yomin Electric est devenue un fournisseur mondial de confiance.',
    about_intro_p2:'Notre usine de 18 000 m² dispose de lignes automatisées, d\'un centre R&D et d\'un laboratoire qualité.',
    about_intro_p3:'370+ ingénieurs et techniciens au service de clients sur 5 continents.',
    ...
    about_history_lbl:'Chronologie', about_history_h2:'Trois Décennies de Croissance', about_history_desc:'D\'un petit atelier à un exportateur mondial.',
    ...
    prod_cat_energy_meter:'Compteurs d\'Énergie', prod_cat_voltage_stabilizer:'Stabilisateurs de Tension', prod_cat_current_transformer:'Transformateurs de Courant', prod_cat_screw_machine:'Machines à Vis', prod_cat_busbar:'Barres Omnibus', prod_cat_flexible_busbar:'Barre Omnibus Flexible', prod_cat_rigid_busbar:'Barre Omnibus Rigide', prod_cat_aluminum_busbar:'Barre Omnibus Aluminium', prod_cat_composite_busbar:'Composite Stratifié', prod_cat_ccs_busbar:'CCS Intégré', prod_cat_heavy_busbar:'Barre Omnibus Renforcée', prod_cat_storage_busbar:'Stockage d\'Énergie', prod_cat_busbar_protection:'Protection Busbar', prod_cat_variac:'Variacs / Transformateurs', prod_cat_terminal:'Bornes & Connecteurs', prod_cat_solar:'Solaire & PV', prod_cat_fuse:'Fusibles & Protection', prod_cat_voltage_protector:'Protecteurs de Tension', prod_cat_socket:'Prises & Câblage', prod_cat_tools:'Outils & Quincaillerie', prod_cat_seal:'Scellés de Sécurité', prod_cat_other:'Autres Produits',
    prod_request_quote:'Demander un Devis', prod_quote_busbar_desc:'Le tarif des barres omnibus dépend du projet. Envoyez vos plans et spécifications pour un devis formel — notre équipe examinera puis négociera les conditions avec vous.', prod_pricing:'Tarification', prod_busbar_choose:'Choisir le type de barre', prod_busbar_all:'Toutes les barres',
      ft_ab:"Zhejiang Yomin Electric Co., Ltd. — Des solutions de mesure d'énergie de précision, approuvées par les compagnies d'électricité et les industries de plus de 95 pays depuis 30 ans.",
    ft_pr:'Produits',
    ft_co:'Entreprise',
    ft_cn:'Contact',
    ft_cp:'© 2025 Zhejiang Yomin Electric Co., Ltd. Tous droits réservés.',
    process_s1_d1:'40+ ingénieurs R&D',
    process_s1_d2:'Tests de conformité IEC/ANSI',
    process_s1_d3:'Développement de firmware',
    process_s1_d4:'Simulation environnementale',
    process_s1_d5:'Cycle de 12 à 18 mois',
    process_s2_d1:'Fournisseurs certifiés uniquement',
    process_s2_d2:'Contrôle qualité à la réception',
    process_s2_d3:'Tests au niveau composant',
    process_s2_d4:'Certification des matériaux',
    process_s2_d5:'Contrôlé selon ISO 9001:2015',
    process_s3_d1:'6 lignes SMT',
    process_s3_d2:'Capacité de 2M PCB/mois',
    process_s3_d3:'Soudure sans plomb',
    process_s3_d4:'Inspection AOI',
    process_s3_d5:'Inspection aux rayons X',
    process_s3_d6:'Conforme RoHS',
    process_s4_d1:'Programmation du firmware',
    process_s4_d2:'Réglage des paramètres client',
    process_s4_d3:'Assemblage à couple contrôlé',
    process_s4_d4:'Vérification du câblage',
    process_s4_d5:'Étiquetage et marquage',
    process_s5_detail1:'Traçabilité NIST/PTB',
    process_s5_detail2:'Étalonnage multi-charges',
    process_s5_detail3:'Test unitaire à 100 %',
    process_s5_detail4:'Vérification IEC 62053',
    process_s5_detail5:'Enregistrements numériques',
    process_s5_detail6:'Test du rapport TC et de la phase',
    process_s6_detail1:'Contrôle visuel et dimensionnel',
    process_s6_detail2:'Test de cycle thermique',
    process_s6_detail3:"Test d'humidité",
    process_s6_detail4:"Tension d'impulsion 6 kV",
    process_s6_detail5:'Test de vibration',
    process_s6_detail6:'Taux de défaut <0,1 %',
},
  ar: {
...
ft_desc:'حلول قياس الطاقة الدقيقة. موثوق به في أكثر من 95 دولة منذ 1996.',
ft_copy:'© 2026 يومين إلكتريك. جميع الحقوق محفوظة.',
    ft_products:'المنتجات', ft_company:'الشركة', ft_contact_lbl:'التواصل',
    about_eyebrow:'قصتنا', about_title:'مبنيون على الدقة والثقة',
    about_desc:'منذ 1996، نصمم حلول قياس الطاقة لأكثر من 95 دولة.',
    about_intro_lbl:'نبذة عن الشركة', about_intro_h2:'شركة يومين إلكتريك',
    about_intro_p1:'تأسست 1996 في تشيجيانغ، ونمت إلى مورد عالمي موثوق.',
    about_intro_p2:'مصنع 18,000 م² بخطوط آلية ومختبر R&D ومراقبة جودة.',
    about_intro_p3:'370+ مهندساً يخدمون عملاء في 5 قارات.',
    ...
    about_history_lbl:'التاريخ', about_history_h2:'ثلاثة عقود من النمو', about_history_desc:'من ورشة صغيرة إلى مصدّر عالمي.',
    ...
    prod_cat_energy_meter:'عدادات الطاقة', prod_cat_voltage_stabilizer:'منظمات الجهد', prod_cat_current_transformer:'محولات التيار', prod_cat_screw_machine:'ماكينات البراغي', prod_cat_busbar:'قضبان النحاس', prod_cat_flexible_busbar:'قضبان نحاسية مرنة', prod_cat_rigid_busbar:'قضبان نحاسية صلبة', prod_cat_aluminum_busbar:'قضبان ألومنيوم', prod_cat_composite_busbar:'مركب طبقي', prod_cat_ccs_busbar:'CCS متكامل', prod_cat_heavy_busbar:'قضبان ثقيلة', prod_cat_storage_busbar:'تخزين الطاقة', prod_cat_busbar_protection:'حماية القضبان', prod_cat_variac:'محولات متغيرة', prod_cat_terminal:'أطراف وموصلات', prod_cat_solar:'الطاقة الشمسية', prod_cat_fuse:'فيوزات وحماية', prod_cat_voltage_protector:'حماية الجهد', prod_cat_socket:'مقابس وأسلاك', prod_cat_tools:'أدوات ومعدات', prod_cat_seal:'أختام أمان', prod_cat_other:'منتجات أخرى',
    ...
    ft_ab:'شركة تشجيانغ يومين للكهرباء المحدودة — حلول قياس طاقة دقيقة موثوق بها لدى شركات المرافق والصناعات في أكثر من 95 دولة منذ 30 عامًا.',
    ft_pr:'المنتجات',
    ft_co:'الشركة',
    ft_cn:'اتصل بنا',
    ft_cp:'© 2025 شركة تشجيانغ يومين للكهرباء المحدودة. جميع الحقوق محفوظة.',
    process_s1_d1:'أكثر من 40 مهندس بحث وتطوير',
    process_s1_d2:'اختبارات الامتثال IEC/ANSI',
    process_s1_d3:'تطوير البرمجيات الثابتة',
    process_s1_d4:'محاكاة بيئية',
    process_s1_d5:'دورة من 12 إلى 18 شهرًا',
    process_s2_d1:'موردون معتمدون فقط',
    process_s2_d2:'فحص الجودة عند الاستلام',
    process_s2_d3:'اختبار على مستوى المكونات',
    process_s2_d4:'شهادة المواد',
    process_s2_d5:'مضبوط وفق ISO 9001:2015',
    process_s3_d1:'6 خطوط SMT',
    process_s3_d2:'طاقة إنتاجية 2 مليون لوحة/شهر',
    process_s3_d3:'لحام خالٍ من الرصاص',
    process_s3_d4:'فحص AOI',
    process_s3_d5:'فحص بالأشعة السينية',
    process_s3_d6:'متوافق مع RoHS',
    process_s4_d1:'برمجة البرمجيات الثابتة',
    process_s4_d2:'ضبط معلمات العميل',
    process_s4_d3:'تجميع بعزم مضبوط',
    process_s4_d4:'التحقق من الأسلاك',
    process_s4_d5:'الملصقات والعلامات',
    process_s5_detail1:'تتبع NIST/PTB',
    process_s5_detail2:'معايرة متعددة الأحمال',
    process_s5_detail3:'اختبار 100% لكل وحدة',
    process_s5_detail4:'التحقق من IEC 62053',
    process_s5_detail5:'سجلات رقمية',
    process_s5_detail6:'اختبار نسبة CT والطور',
    process_s6_detail1:'فحص بصري وأبعاد',
    process_s6_detail2:'اختبار دورة الحرارة',
    process_s6_detail3:'اختبار الرطوبة',
    process_s6_detail4:'جهد نبضي 6 كيلو فولت',
    process_s6_detail5:'اختبار الاهتزاز',
    process_s6_detail6:'معدل عيوب أقل من 0.1%',
  }
};
if (window.__ymT) {
...
/* ─── THEME ─────────────────────────────────────────── */
function setTheme(t, fromAuto = false) {
  currentTheme = t;
...
(function initNav() {
  ...
  const btnDark = document.getElementById('btnDark');
  const btnLight = document.getElementById('btnLight');
  if (btnDark) btnDark.addEventListener('click', () => { storedTheme = 'dark'; setTheme('dark', false); });
  if (btnLight) btnLight.addEventListener('click', () => { storedTheme = 'light'; setTheme('light', false); });
...
(function injectFloatButtons() {
  ...
  // WeChat + WhatsApp + LinkedIn stacked buttons
  const wrap = document.createElement('div');
  wrap.className = 'float-btns';
  wrap.innerHTML = `
    <a href="https://www.linkedin.com/company/yominelectric" target="_blank" rel="noopener" class="float-btn float-btn-li" aria-label="LinkedIn">
      <svg viewBox="0 0 24 24" width="24" height="24" fill="white"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
      <span class="float-btn-label">LinkedIn</span>
    </a>
    ...
    <a href="https://wa.me/8618458440466" target="_blank" rel="noopener" class="float-btn float-btn-wa" aria-label="WhatsApp">
