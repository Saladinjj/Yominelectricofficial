"""Apply Pinterest chrome to the 2026-09-24 realistic on-site in-use images.
Generates:
  * assets/images/blog/{slug}/hero.png + hero.webp (1280x720)
  * assets/images/blog/{slug}/card.png + card.webp (960x540)
  * media-output/linkedin-2026-09-24/{slug}.png (1080x1350, 4:5 vertical)
"""
import os
from PIL import Image

BASE = r'C:\Users\Saladin\Desktop\yominelectric-main'
LIDIR = os.path.join(BASE, 'media-output', 'linkedin-2026-09-24')
...
JOBS = [
    dict(
        ...
        scene='media-output/img-mufjqrzl-f3e4753d.png',
        title='Insulated Comb Busbar | Pin & Fork Modular MCB Link',
        chips=['63A–100A Copper Conductor', '1P to 4P Multi-Pole Options', 'Flame-Retardant PVC Shell']
    ),
    dict(
        slug='wall-mounted-voltage-stabilizer-guide',
        scene='media-output/img-mufjs4e1-23c009a4.png',
        title='Wall-Mounted Voltage Stabilizer | Automatic Home AVR',
        chips=['1kVA–10kVA Servo & Relay', 'Dual Digital LED Display', 'Air Conditioner Duty Cycle']
    ),
    dict(
        slug='dc-power-panel-guide',
        scene='media-output/img-mufjtfsz-b64e3681.png',
        title='DC Power Supply Panel | Substation GZDW Auxiliary System',
        chips=['110V / 220V DC Control Bus', 'High-Frequency Switch Rectifier', 'Intelligent Battery Charger']
    ),
]
