# -*- coding: utf-8 -*-
"""Generate the 2026-09-22 canonical blog pages.
...
from blog_content_0922 import BLOGS
...
CTA = {
    'three-phase-voltage-stabilizer-guide': (
        'Specifying industrial three-phase automatic voltage stabilizers or compensated power regulators for manufacturing plants?',
        'Tell us your system line voltage (380V, 400V, or 415V), plant capacity in kVA, and connected load profile. '
        'YOMIN manufactures precision 15kVA to 500kVA copper servo stabilizers with individual phase regulation.',
        'Browse the voltage stabilizer range', '/products/voltage-stabilizer-regulator'),
    'three-phase-variac-guide': (
        'Designing high-current electrical test benches, motor repair test bays, or industrial calibration stations?',
        'Specify your required testing capacity (3kVA to 50kVA), voltage range (0-430V AC), and load characteristics. '
        'YOMIN supplies heavy-duty TSGC2 three-phase rotary autotransformers with pure copper toroidal coils and smooth dial regulation.',
        'Browse the variac transformer range', '/products/variac-transformer'),
    'relay-voltage-stabilizer-guide': (
        'Distributing residential and commercial electrical voltage regulators in emerging markets with unstable grids?',
        'Tell us your utility grid voltage range (95V-270V or 140V-260V) and appliance load requirements. '
        'YOMIN manufactures fast-switching (<10ms) relay-type voltage stabilizers with digital LED displays and 3-minute compressor delay protection.',
        'Browse the voltage stabilizer range', '/products/voltage-stabilizer-regulator'),
}
