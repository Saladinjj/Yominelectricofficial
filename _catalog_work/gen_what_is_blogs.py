# -*- coding: utf-8 -*-
"""Generate the canonical 'What Is' blog pages.
...
from blog_content_what_is import BLOGS
...
CTA = {
    'what-is-a-voltage-stabilizer': (
        'Looking to source single-phase or three-phase automatic voltage stabilizers (AVRs) for home appliances, commercial facilities, or industrial manufacturing plants?',
        'Tell us your grid voltage fluctuation range, equipment power rating in kVA, and single or three-phase configuration. '
        'YOMIN manufactures 500VA to 500kVA servo and relay stabilizers engineered to international standards.',
    ...
    'what-is-a-surge-protective-device': (
        ...
        'Specify your system voltage tier (230V/400V AC or 600V-1500V DC), discharge current ratings, and mounting format. '
        'YOMIN manufactures TUV and CE certified surge protective devices engineered to IEC 61643 standards.',
    ...
    'what-is-a-fuse-cutout': (
        ...
        'Tell us your line operating voltage, continuous current rating (100A or 200A), and interrupting capacity requirements. '
        'YOMIN manufactures heavy-duty fuse cutouts tested strictly to ANSI C37.42 and IEC 60282-2.',
...
print('Successfully generated %d canonical What Is blog pages!' % len(written))
