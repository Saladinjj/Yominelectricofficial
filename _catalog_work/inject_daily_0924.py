# -*- coding: utf-8 -*-
"""Add the three 2026-09-24 blogs to blog.html (cards + blogPost JSON-LD) and
...
POSTS = [
    ...
    dict(slug='wall-mounted-voltage-stabilizer-guide',
    ...
    dict(slug='dc-power-panel-guide',
